    ...
    <div class="d-flex align-items-stretch">
      ...
      <div class="page-content">
        <div class="page-header">
          ...
          <div class="col-lg-6">
                <div class="block">
                  <div class="title"><strong class="d-block">New Student</strong></div>
                  <div class="block-body">
                    <form  action="" method="POST">
                        <div class="form-group">
                        <label class="form-control-label">Student Name</label>
                          <input type="text" placeholder="Student Name" name="StudentName" class="form-control" required>
                      </div>

                      <div class="form-group">
                        <label class="form-control-label">Student ID</label>
                        <input type="text" placeholder="Student ID" name="StudentID" class="form-control" required>
                      </div>
                        <div class="form-group">
                      ...
                      <input type="password" placeholder="Level" name="level" class="form-control" required>
                    </div>
