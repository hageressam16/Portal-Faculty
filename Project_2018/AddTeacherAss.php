...
if ($_SERVER ['REQUES_METHOD'] = 'POST' && isset($_POST['add']) ) {
  $admin = $admin->AddTeacherAss($_POST);
    ...
    <div class="d-flex align-items-stretch">
      ...
      <div class="page-content">
        <div class="page-header">
          ...
          <div class="col-lg-6">
                <div class="block">
                  <div class="title"><strong class="d-block">Add TeacherAssisant</strong></div>
                  <div class="block-body">
                    <form  action="" method="POST">
                        <div class="form-group">
                        <label class="form-control-label">TeacherAssisant Name</label>
                          <input type="text" placeholder="TeacherAssisant Name" name="TeacherAssisantName" class="form-control" required>
                      </div>

                      <div class="form-group">
                        <label class="form-control-label">TeacherAssisant ID</label>
                        <input type="text" placeholder="TeacherAssisant ID" name="TeacherAssisantID" class="form-control" required>
                      </div>
                        <div class="form-group">
                      ...
                      <div class="form-group">
                        <input type="submit"  name="add" value="Add TeacherAssisant" class="btn btn-primary">
                      </div>
                    </form>
                  </div>
                </div>
