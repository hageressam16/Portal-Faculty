    ...
    <div class="d-flex align-items-stretch">
      ...
      <div class="page-content">
        <div class="page-header">
          ...
          <div class="col-lg-6">
                <div class="block">
                  <div class="title"><strong class="d-block">Add Course</strong></div>
                  <div class="block-body">
                    <form  action="" method="POST">
                        <div class="form-group">
                        <label class="form-control-label">Course Name</label>
                          <input type="text" placeholder="Course Name" name="CourseName" class="form-control" required>
                      </div>

                      <div class="form-group">
                        <label class="form-control-label">Course ID</label>
                        <input type="text" placeholder="Course ID" name="CourseID" class="form-control" required>
                      </div>
